...
> This directory contains all the tasks of the project "0x02. AirBnB clone - MySQL" at [ALX Software Engineering]
...
The Airbnb clone is one of the main projects at ALX SE School, it's a long term project that we need to accomplish by building up trough a series of small modules or pieces. This project is thinking as a whole for a software developer, to learn and become a full-stack developer, gluing alltogether the infrastructure of the Airbnb from back to front, including databases, static and dynamic content, web frameworks, APIs, and web infrastructure.
...
You can find this in: [AirBnB clone - The console](https://github.com/Itecrom/AirBnB_clone_v2.git)
